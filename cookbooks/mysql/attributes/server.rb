...
when "centos", "redhat", "fedora", "suse", "scientific", "amazon"
  ...
  set['mysql']['replication_master_path']     = "/etc/replication_master.sql"
  set['mysql']['replication_slave_path']     = "/etc/replication_slave.sql"
...
when "freebsd"
  ...
  set['mysql']['replication_master_path']     = "/var/db/replication_master.sql"
  set['mysql']['replication_slave_path']     = "/var/db/replication_slave.sql"
